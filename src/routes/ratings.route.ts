...
class RatingsRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(`${this.path}`, authMiddleware, validationMiddleware(CreateRatingDto, 'body'), this.ratingsController.createRating);
    this.router.put(`${this.path}/:id(\\d+)`, validationMiddleware(CreateRatingDto, 'body', true), this.ratingsController.updateRating);
